...
class CANOAAV2:
    ...
    def __init__(self):
        ...
        self.base_triples.properties.isLocatedIn = [
            (self.properties.isLocatedIn, RDFS.label, Literal('isLocatedIn')),
            (self.properties.isLocatedIn, RDF.type, RDF.Property)
        ]
        self.base_triples.properties.elevUnit = [
            (self.properties.elevUnit, RDFS.label, Literal('elevUnit')),
        ...
        self.base_triples.properties.inDataCategory = [
            (self.properties.inDataCategory, RDFS.label, Literal('inDataCategory')),
        ...
        self.base_triples.properties.inLocationCategory = [
            (self.properties.inLocationCategory, RDFS.label, Literal('inLocationCategory')),
        ...
        self.base_triples.properties.recordedInDataset = [
            (self.properties.recordedInDataset, RDFS.label, Literal('recordedInDataset')),
        ...
        self.base_triples.properties.sourceStation = [
            (self.properties.sourceStation, RDFS.label, Literal('sourceStation')),
        ...
        self.base_triples.properties.withDataType = [
            (self.properties.withDataType, RDFS.label, Literal('withDataType')),
        ...
        self.base_triples.properties.attributeFlag = [
            (self.properties.attributeFlag, RDFS.label, Literal('attributeFlag')),
