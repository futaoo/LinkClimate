...
ca_str = "http://jresearch.ucd.ie/ont/ca/resource/"
...
for row in record_rows:
    ...
    iri_station_location = URIRef(ca_str + "location/" + row[record_head.index("STATION")])
    iri_station_sensor_prcp =  URIRef(ca_str + "sensor/" + "prcp/" + row[record_head.index("STATION")])
    iri_station_sensor_tprt =  URIRef(ca_str + "sensor/" + "tprt/" + row[record_head.index("STATION")])
    bn_station_sensor_prcp_observation = URIRef(ca_str + "obsv/"  + "sensor/" + "prcp/" + row[record_head.index("STATION")] + "/" + row[record_head.index("DATE")])
    bn_station_sensor_tprt_observation = URIRef(ca_str + "obsv/"  + "sensor/" + "tprt/" + row[record_head.index("STATION")] + "/" + row[record_head.index("DATE")])

    bn_prcp_result_prcp = URIRef(ca_str + "result/" + "sensor/" + "prcp/" + "prcp/" + row[record_head.index("STATION")] + "/" + row[record_head.index("DATE")]) #BNode() 
    bn_prcp_result_snwd = URIRef(ca_str + "result/" + "sensor/" + "prcp/" + "snwd/" + row[record_head.index("STATION")] + "/" + row[record_head.index("DATE")]) #BNode()
    bn_tprt_result_avg = URIRef(ca_str + "result/" + "sensor/" + "tprt/" + "tavg/" + row[record_head.index("STATION")] + "/" + row[record_head.index("DATE")]) #BNode()
    bn_tprt_result_max = URIRef(ca_str + "result/" + "sensor/" + "tprt/" + "tmax/" + row[record_head.index("STATION")] + "/" + row[record_head.index("DATE")]) #BNode()
    bn_tprt_result_min = URIRef(ca_str + "result/" + "sensor/" + "tprt/" + "tmin/" + row[record_head.index("STATION")] + "/" + row[record_head.index("DATE")]) #BNode()
